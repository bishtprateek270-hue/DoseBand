...
class DoseBandInferencePipeline:
    ...
    def run_full_inference(
        ...
        return {
            ...
            "prototype_version": roi_detections.get("prototype_version", "PROTOTYPE_V2"),
            ...
            "user_message": val_res.get("user_message", "✅ Valid 3D-Printed DoseBand Prototype Detected & Verified."),
            "roi_detections": roi_detections,
            "annotated_overlay": annotated_overlay,
            "debug_overlay": debug_overlay,
